...
var twitterFetcher = function () {
    ...
    return {
        fetch: function (a) {
            ...
            a = [];
            var f = [], g = [], h = [], b = [], n = [], e = 0;
            if (u)for (c = c.getElementsByClassName("tweet"); e <
            c.length;) {
                ...
                e++
            } else for (c = m(c, "tweet"); e < c.length;)a.push(m(c[e], "e-entry-title")[0]),
            ...
            for (b = 0; b < e;) {
                if ("string" !== typeof t) {
                    ...
                    if (a[b].innerText)if (u)g[b].innerText = d; else {
                        var l = document.createElement("p"), C = document.createTextNode(d);
                        l.appendChild(C);
